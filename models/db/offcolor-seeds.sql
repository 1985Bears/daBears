...
('Wheat Beer', 'Fierce', 'Berliner Weisse', 3.8, 'Troublesomes meaner cousin will flail your tongue as hard as he can, but being such a little guy, you will probably just pucker a bit. Spawned through an overnight kettle souring with our house lactobacillus culture, the wort emerges furious at what we did to it. Then, just because, we pitch a saison yeast and allow it to free rise to its further distain. It comes out angrier than... uh, angrier than... well, something really angry. But at 3.8% ABV there is no reason for you to be too afraid.', 1),

('Farmhouse/Saison', 'Le Predateur', 'French Style Saison', 6.5, 'A beret-wearing, baguette-eating, mustached farmhouse ale made with French malts, French saison yeast, and Australian hops... what?', 1),

('Porter/Stout', 'Known Gnome', 'Porter', 6.7, 'Known Gnome is a throwback to when old timey porter brewers tried to avoid paying hop taxes by (illegally) using quassia as a hop substitute. The bark of quassia came into fashion in the early 19th century as a bitter tonic in herbal medicine.Known Gnome also gets its unusual sweetness from licorice root and the naturally contained chemical glycyrrhizic acid which is 50 times sweeter tasting than sucrose. Notes of nuts and biscuits if they were briefly introduced to a coffee roaster. Sweetness and tannins further complement the biscuit backbone while it finishes dry on the palate with a kiss of fleeting brown malt.', 1);