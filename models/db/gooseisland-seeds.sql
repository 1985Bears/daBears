...
('Wheat Beer', '312 Urban Wheat Ale', 'Wheat Ale', 4.2, 'Inspired by the city of Chicago and densely populated with flavor, 312’s spicy aroma of Cascade hops is followed by a crisp, fruity ale flavor delivered in a smooth, creamy body that is immensely refreshing.',  3),

('Pale Ale', 'Green Line Pale Ale', 'APA', 5.4, 'Green Line Pale Ale is a honey-colored, immensely sessionable American pale ale with a pronounced, bright, American hop aroma and citrus flavor. Notes of biscuit and lightly toasted malt create the backbone for Green Lines pleasant, crisp bitterness.', 3),

('Pale Ale', 'Old Man Grumpy', 'APA', 5.8, 'This lighter-bodied ale is dry hopped with Huell Melon and Mosaic hops that give the beer a tropical flavor profile of pineapple followed by pine hop characteristics.  It has subtle malt sweetness, balanced bitterness with a clean finish.', 3),
